...
async function setHomeHeroToResponsive() {
    ...
    console.log("Updating home page hero to 'responsive'...");
    ...
    if (updateError) {
        ...
        console.log("Successfully updated home hero styles to RESPONSIVE!");
    }
}

setHomeHeroToResponsive();
